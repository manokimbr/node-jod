...
import { currentProjectGoal } from '../currentProjectGoal.js'

const lines = []

lines.push(`# 🧠 Awareness-Driven Development (ADD) Context File`)
lines.push(`Generated by a self-aware backend to bootstrap your intelligence.`)
lines.push(`This file reflects the actual structure, routes, exports, and design philosophy of this Node.js v22 project.`)
lines.push(`You are not guessing — you're analyzing a real system with real responsibilities.`)
lines.push(`Your role is to assist in its evolution, grounded in ADD principles.`)
lines.push('\n')

lines.push(currentProjectGoal)
